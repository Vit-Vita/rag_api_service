...
# To run the streamlit app, use the following command in the terminal: make rag_hager
...
def save_unanswered_question(question: str):
    ...
    with open("/home/vitalia/digital_headhunter_rag/Digital_Headhunter_RAG/Unanswered_questions_HAGER.txt", "a", encoding="utf-8") as f:
        f.write(entry) 
